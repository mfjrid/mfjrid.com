...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ url('/') }}/public-assets/images/favicon.svg">
    <title>Muhammad Fajar - MFJRID</title>
    <!-- Bootstrap min css -->
    <link rel="stylesheet" href="{{ url('/') }}/public-assets/css/vendor/fontawesome.css">
    <link rel="stylesheet" href="{{ url('/') }}/public-assets/css/plugins/swiper.css">
    <link rel="stylesheet" href="{{ url('/') }}/public-assets/css/plugins/odometer.css">
    <link rel="stylesheet" href="{{ url('/') }}/public-assets/css/vendor/animate.min.css">
    ...
    <link rel="stylesheet" href="{{ url('/') }}/public-assets/css/style2.css?<?= time() ?>">
</head>

<body class="spybody color-blue tmp-white-version" data-spy="scroll" data-bs-target=".navbar-example2"
    data-offset="150">
            ...
            <div class="row align-items-center pt--50">
                <div class="col-lg-7">
                    <div class="banner-right-thumb-left-content">
                        <span class="pre-title">Hi, I'm Fajar</span>
                        <h1 class="title">
                            Hello, From Me
                            <br> A
                            <span class="header-caption">
                                <span class="cd-headline clip is-full-width">
                                    <span class="cd-words-wrapper">
                                        <b class="is-visible theme-gradient">Web Developer</b>
                                        <b class="is-hidden theme-gradient">UI / UX Designer</b>
                                    </span>
                                </span>
                            </span>
                        </h1>
                        <p class="disc">Crafting seamless user experiences and powerful web solutions. I turn ideas
                            into interactive, user-focused digital products.</p>
                        <div class="find-me-on">
                            <h2 class="find-me-on-title">Find me on</h2>
                            <div class="social-link banner">
                                <a href="https://instagram.com/mfjrid" target="_blank"><i
                                        class="fa-brands fa-instagram"></i></a>
                                <a href="https://linkedin.com/in/mfjrid" target="_blank"><i
                                        class="fa-brands fa-linkedin-in"></i></a>
                                <a href="https://twitter.com/mfjrid" target="_blank"><i
                                        class="fa-brands fa-twitter"></i></a>
                                <a href="https://facebook.com/mfjrid" target="_blank"><i
                ...
                <div class="col-lg-5">
                    <div class="">
                        <div class="thumbnail-right-inner-main-image tmponhover">
                            <img src="{{ url('/') }}/img/home-image.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="about-us-left-content-wrap bg-vactor-one">
                        ...
                        <div class="design-card tmp-scroll-trigger tmp-fade-in animation-order-2">
                            ...
                            <div class="card-info">
                                ...
                                <p class="card-para">50+ Projects</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about-us-right-content-wrap">
                        <div class="section-head text-align-left mb--50">
                            ...
                            <h2 class="title split-collab tmp-scroll-trigger tmp-fade-in animation-order-2">I turn ideas
                                into interactive, user-focused digital products.</h2>
                            <p class="description tmp-scroll-trigger tmp-fade-in animation-order-3">
                                With years of experience building modern web applications, I specialize in Laravel for
                                backend development, WordPress for content-driven sites, and Figma for crafting clean,
                        ...
                        <div class="about-us-section-card row g-5">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="about-us-card tmponhover tmp-scroll-trigger tmp-fade-in animation-order-4">
                                    <div class="card-head">
                                        <div class="logo-img">
                                            <img src="{{ url('/') }}/public-assets/images/about/logo-1.svg"
                                                alt="logo">
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="about-us-card tmponhover tmp-scroll-trigger tmp-fade-in animation-order-5">
                                    <div class="card-head">
                                        <div class="logo-img">
                                            <img src="{{ url('/') }}/public-assets/images/about/logo-2.svg"
                                                alt="logo">
                                        </div>
    ...
    <section class="my-skill-area-style-two plr--120 plr_lg--30 plr_md--30 plr_sm--30 plr_mobile--15 mt--10"
        id="resume">
        <div class="tpm-custom-box-bg tmponhover border--radious-20">
            <div class="container">
                <div class="row">
                        ...
                        <div class="my-skill-card-style-two row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="my-skill-card tmp-scroll-trigger tmp-fade-in animation-order-1">
                                    <div class="card-icon">
                                        <img src="{{ url('/') }}/public-assets/images/icons/icon-01.png"
                                            alt="my-skill-icon">
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="my-skill-card tmp-scroll-trigger tmp-fade-in animation-order-2">
                                    <div class="card-icon">
                                        <img src="{{ url('/') }}/public-assets/images/icons/icon-02.png"
                                            alt="my-skill-icon">
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="my-skill-card tmp-scroll-trigger tmp-fade-in animation-order-3">
                                    <div class="card-icon">
                                        <img src="{{ url('/') }}/public-assets/images/icons/icon-03.png"
                                            alt="my-skill-icon">
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="my-skill-card tmp-scroll-trigger tmp-fade-in animation-order-4">
                                    <div class="card-icon">
                                        <img src="{{ url('/') }}/public-assets/images/icons/icon-04.png"
                                            alt="my-skill-icon">
                                    </div>
    ...
    <section class="latest-portfolio-area custom-column-grid tmp-section-gap" id="portfolio">
        <div class="container">
            ...
            <div class="latest-portfolio-tabs-area">
                    ...
                    <ul class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <li>
                            <button class="nav-link" id="nav-design-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-design" type="button" role="tab"
                                aria-controls="nav-design" aria-selected="false">Design</button>
                        </li>
                        <li>
                ...
                <div class="tab-content bg-blur-style-one" id="nav-tabContent">
                        ...
                        <div class="row">
                                ...
                                <div
                                    ...
                                    <div class="portfoli-card-img">
                                        <div class="img-box v2">
                                            <a class="tmp-scroll-trigger tmp-zoom-in animation-order-1"
                                                ...
                                                <img class="w-100"
                                                    src="{{ url('/') }}/public-assets/images/latest-portfolio/portfoli-img-1.jpg"
                                                    alt="Thumbnail">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="portfolio-card-content-wrap">
                                        <div class="content-left">
                                            <h3 class="portfolio-card-title"><a href="project-details-white.html">SAAS
                                                    website
                                                    design</a></h3>
                                            <div class="tag-items">
                                                <ul>
                            ...
                            <div class="col-lg-6">
                                <div
                                    ...
                                    <div class="portfoli-card-img">
                                        <div class="img-box v2">
                                            <a class="tmp-scroll-trigger tmp-zoom-in animation-order-1"
                                                href="project-details-white.html">
                                                <img class="w-100"
                                                    src="{{ url('/') }}/public-assets/images/latest-portfolio/portfoli-img-3.jpg"
                                                    alt="Thumbnail">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="portfolio-card-content-wrap">
                                        <div class="content-left">
                                            <h3 class="portfolio-card-title"><a
                                                    href="project-details-white.html">Workout App
                                                    design</a></h3>
                                            <div class="tag-items">
                                                <ul>
                                                    <li>
                                    ...
                                    <div class="portfoli-card-img">
                                        <div class="img-box v2">
                                            <a class="tmp-scroll-trigger tmp-zoom-in animation-order-1"
                                                href="project-details-white.html">
                                                <img class="w-100"
                                                    src="{{ url('/') }}/public-assets/images/latest-portfolio/portfoli-img-4.jpg"
                                                    alt="Thumbnail">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div
                                    ...
                                    <div class="portfoli-card-img">
                                        <div class="img-box v2">
                                            <a class="tmp-scroll-trigger tmp-zoom-in animation-order-1"
                                                href="project-details-white.html">
                                                <img class="w-100"
                                                    src="{{ url('/') }}/public-assets/images/latest-portfolio/portfoli-img-2.jpg"
                                                    alt="Thumbnail">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="portfolio-card-content-wrap">
                                        <div class="content-left">
                                            <h3 class="portfolio-card-title"><a
                                                    href="project-details-white.html">Dashboard
                                                    design</a></h3>
                                            <div class="tag-items">
                                                <ul>
                                                    <li>
                    ...
                    <div class="tab-pane fade" id="nav-marketing" role="tabpanel"
                        aria-labelledby="nav-marketing-tab" tabindex="0">
                        <div class="row">
                            <div class="col-lg-6">
                                <div
                                    class="latest-portfolio-card-style-two image-box-hover tmp-scroll-trigger tmp-fade-in animation-order-1">
    ...
    <section class="our-price-plan-area tmp-section-gapBottom" id="pricing">
        <div class="container">
            <div class="section-head mb--60">
                <div class="section-sub-title center-title tmp-scroll-trigger tmp-fade-in animation-order-1">
                        ...
                        <div class="blog-card-img">
                            <div class="img-box">
                                <a href="blog-details.html">
                                    <img class="w-100"
                                        src="{{ url('/') }}/public-assets/images/blog/blog-img-1.jpg"
                                        alt="Blog Thumbnail">
                                </a>
                            </div>
                            <span>12 Feb</span>
                    ...
                    <div
                        ...
                        <div class="blog-card-img">
                            <div class="img-box">
                                <a href="blog-details.html">
                                    <img class="w-100"
                                        src="{{ url('/') }}/public-assets/images/blog/blog-img-2.jpg"
                                        alt="Blog Thumbnail">
                                </a>
                            </div>
                            <span>12 Feb</span>
                        ...
                        <div class="blog-content-wrap">
                            ...
                            <h3 class="blog-title"><a href="blog-details.html">Let’s bring your ideas to life!
                                    Contact me, and let’s</a></h3>
                    ...
                    <div
                        ...
                        <div class="blog-card-img">
                            <div class="img-box">
                                <a href="blog-details.html">
                                    <img class="w-100"
                                        src="{{ url('/') }}/public-assets/images/blog/blog-img-3.jpg"
                                        alt="Blog Thumbnail">
                                </a>
                            </div>
                            <span>12 Feb</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-area text-center">
                        <div class="logo">
                            <a href="index.html">
                                <img src="{{ url('/') }}/public-assets/images/logo/logo-blue-white.svg"
                        ...
                        <p class="description mt--30">©
                            ...
                            . All rights reserved by <a target="_blank"
                                href="https://themeforest.net/user/inversweb/portfolio">InversWeb.</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="wrapper">
            ...
            <div class="chat-box">
                ...
                <form class="tmp-dynamic-form" action="#">
                    ...
                    <div class="field">
                        <input class="input-field" name="email" placeholder="Your Email" type="email"
                            required>
                    </div>
                                    ...
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-1.png"
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-02.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-2.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-03.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-3.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-04.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-4.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-05.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-5.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-06.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-6.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-07.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-7.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-08.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-8.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-09.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-9.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-10.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-10.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-11.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-11.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-12.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-12.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-13.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-13.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-14.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-14.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-15.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-15.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-16.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-16.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-17.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-17.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-18.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-18.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-19.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-19.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-20.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-20.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-21.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-21.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-22.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-22.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                    ...
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="#">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/coming-soon.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-1-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-02-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-2-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-03-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-3-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-04-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-4-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-05-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-5-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-06-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-6-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-07-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-7-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-08-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-8-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-09-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-9-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-10-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-10-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-11-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-11-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-12-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-12-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-13-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-13-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-14-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-14-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-15-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-15-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-16-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-16-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-17-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-17-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-18-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-18-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-19-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-19-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-20-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-20-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-21-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-21-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="index-22-white.html">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/home-22-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                    ...
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="#">
                                                    <img class="w-100"
                                                        src="{{ url('/') }}/public-assets/images/demo/coming-soon-white.png"
                                                        alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
    ...
    <script src="{{ url('/') }}/public-assets/js/plugins/odometer.js"></script>
    <script src="{{ url('/') }}/public-assets/js/vendor/appear.js"></script>


    <script src="{{ url('/') }}/public-assets/js/vendor/jquery-one-page-nav.js"></script>
    <script src="{{ url('/') }}/public-assets/js/plugins/swiper.js"></script>

    <script src="{{ url('/') }}/public-assets/js/plugins/gsap.js"></script>
    <script src="{{ url('/') }}/public-assets/js/plugins/splittext.js"></script>
    <script src="{{ url('/') }}/public-assets/js/plugins/scrolltigger.js"></script>
    <script src="{{ url('/') }}/public-assets/js/plugins/scrolltoplugins.js"></script>
    <script src="{{ url('/') }}/public-assets/js/plugins/smoothscroll.js"></script>
    <!-- bootstrap Js-->
    <script src="{{ url('/') }}/public-assets/js/vendor/bootstrap.min.js"></script>
    <script src="{{ url('/') }}/public-assets/js/vendor/waw.js"></script>
    <script src="{{ url('/') }}/public-assets/js/plugins/isotop.js"></script>
    <script src="{{ url('/') }}/public-assets/js/plugins/animation.js"></script>
    <script src="{{ url('/') }}/public-assets/js/plugins/contact.form.js"></script>
    <script src="{{ url('/') }}/public-assets/js/vendor/backtop.js"></script>
    <script src="{{ url('/') }}/public-assets/js/plugins/text-type.js"></script>
    <!-- custom Js -->
