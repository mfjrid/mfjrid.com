        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="header-content">
                    <div class="logo">
                        <a href="index.html">
                            <img class="logo-dark" src="{{ url('/') }}/public-assets/images/logo/logo-blue.svg"
                                alt="Reeni - Personal Portfolio HTML Template for developers and freelancers">
                            <img class="logo-white"
                                src="{{ url('/') }}/public-assets/images/logo/logo-blue-white.svg"
                                alt="Reeni - Personal Portfolio HTML Template for developers and freelancers">
                        </a>
                    </div>
                    <div class="tmp-mainmenu-nav d-none d-xl-block">
                        <nav class="navbar-example2 onepagenav">
                            <ul class="tmp-mainmenu nav nav-pills">
                                ...
                                <li class="nav-item"><a class="smoth-animation" href="#pricing">Pricing</a></li>
                                <li class="nav-item"><a class="smoth-animation" href="#blog">Blog</a></li>
                    ...
                    <div class="tmp-header-right">
                        ...
                        <div class="tmp-side-collups-area d-block d-xl-none">
                            <button class="hamberger-menu humberger_menu_active"><i id="menuBtn"
                                    class="fa-light fa-bars humberger-menu"></i></button>
                        </div>
                    </div>
            ...
            <div class="header-top">
                <div class="logo">
                    <a href="index.html" class="logo-area">
                        <img class="logo-dark" src="{{ url('/') }}/public-assets/images/logo/logo-blue.svg"
                            alt="logo">
                        <img class="logo-white" src="{{ url('/') }}/public-assets/images/logo/logo-blue-white.svg"
                            alt="logo">
                    </a>
                </div>
